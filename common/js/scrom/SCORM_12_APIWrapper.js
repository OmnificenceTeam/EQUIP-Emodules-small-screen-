...
**
*******************************************************************************/
function SCROMManager() {
    this.debug = true;  // set this to false to turn debugging off

    this.output = window.console; // output can be set to any object that has a log(string) function
    // such as: var output = { log: function(str){alert(str);} };

    // Define exception/error codes
    this._NoError = { "code": "0", "string": "No Error", "diagnostic": "No Error" };
    this._GeneralException = { "code": "101", "string": "General Exception", "diagnostic": "General Exception" };
...
SCROMManager.prototype.doLMSInitialize = function()
{
...
**
*******************************************************************************/
SCROMManager.prototype.doLMSFinish=function()
{
   if (! this.initialized) return "true";
...
**
*******************************************************************************/
SCROMManager.prototype.doLMSGetValue=function(name)
{
   var api = this.getAPIHandle();
   var result = "";
   if (api == null)
...
**
*******************************************************************************/
SCROMManager.prototype.doLMSSetValue=function(name, value)
{
   var api = this.getAPIHandle();
   var result = "false";
   if (api == null)
...
**
*******************************************************************************/
SCROMManager.prototype.doLMSCommit=function()
{
   var api = this.getAPIHandle();
   var result = "false";
   if (api == null)
   ...
   {
      var err = this.ErrorHandler(); // get why doLMSInitialize() returned false
      this.message("LMSCommit failed - Could not initialize communication with the LMS - error code: " + err.code);
   }
   else
   {
...
**
*******************************************************************************/
SCROMManager.prototype.doLMSGetLastError=function()
{
   var api = this.getAPIHandle();
   if (api == null)
   {
...
**
********************************************************************************/
SCROMManager.prototype.doLMSGetErrorString=function(errorCode)
{
   var api = this.getAPIHandle();
   if (api == null)
   {
...
**
*******************************************************************************/
SCROMManager.prototype.doLMSGetDiagnostic=function(errorCode)
{
   var api = this.getAPIHandle();
   if (api == null)
   {
...
** }
*******************************************************************************/
SCROMManager.prototype.ErrorHandler=function()
{
   var error = {"code":this._NoError.code, "string":this._NoError.string, "diagnostic":this._NoError.diagnostic};
   var api = this.getAPIHandle();
   if (api == null)
   {
...
**
*******************************************************************************/
SCROMManager.prototype.getAPIHandle=function()
{
...
**
*******************************************************************************/
SCROMManager.prototype.findAPI=function(win)
{
	var findAPITries = 0;
...
**
*******************************************************************************/
SCROMManager.prototype.getAPI=function()
{
...
*******************************************************************************/
SCROMManager.prototype.message=function(str)
{
   if(this.debug)
   {
      //output.log(str);
...
var g_scromManager = new SCROMManager();
g_scromManager.getAPIHandle();

if (window.dialogArguments!=null) {
    g_scromManager = window.dialogArguments;
}

SCROMManager.prototype.doSendCourseCompletionMail=function(name, value)
{
   var api = this.getAPIHandle();
   var result = "false";
   if (api == null)
   {
      this.message("Unable to locate the LMS's API Implementation.\nSendCourseCompletionMail was not successful.");
   }
   else if (! this.initialized && ! this.doLMSInitialize())
   {
      var err = this.ErrorHandler(); // get why doLMSInitialize() returned false
   ...
   {
      result = api.SendCourseCompletionMail(name, value);
      if (result.toString() != "true")
      {
         var err = this.ErrorHandler();
         this.message("SendCourseCompletionMail("+name+", "+value+") failed. \n"+ err.code + ": " + err.string);
      }
   }
